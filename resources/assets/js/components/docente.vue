	    	...
	    	<div class="modal" :class="{'mostrar' : modal}" style="overflow-y: auto;">
                    <div class="modal-content login" style="width: auto !important;">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==1" class="btn btn-primary animated" @click="RegistrarUsuario()">Guardar</button>
                            <button type="button" v-if="tipoAccion==2" class="btn btn-primary animated" @click="ActualizarUsuario()">Actualizar</button>
                        </div>
                    </div>
            </div>
	        <div class="col-md-8">
	                	...
	                	<tbody>
	                		<tr v-for="datadocentes in docentes" :key="datadocentes.idDocente">
	                			...
	                			<td>
				                   ...
				                   <button name="eliminar" class="btn btn-yellow" @click="EliminarUsuario(datadocentes.idDocente)">Eliminar</button>
	                			</td>
	                		</tr>
	                	</tbody>
	                </table>
